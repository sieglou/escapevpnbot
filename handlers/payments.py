...
👇 Нажмите "Продлить" для выбора тарифа
            """
...
🎯 <b>Рекомендуем:</b> 12 месяцев - самая выгодная цена!
        """
